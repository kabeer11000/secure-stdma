...
NS3_EXECUTABLE_PATH = ['/root/secure-stdma/sources/build/src/emu', '/root/secure-stdma/sources/build/src/fd-net-device', '/root/secure-stdma/sources/build/src/tap-bridge']
NS3_LIBS = ['ssl', 'crypto']
...
cfg_files = ['/root/secure-stdma/sources/build/ns3/config-store-config.h', '/root/secure-stdma/sources/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
