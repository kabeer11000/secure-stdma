...
CC = ['/usr/bin/gcc']
CCDEFINES = []
CCFLAGS = ['-O3', '-g', '-Wall', '-Werror', '-Wall', '-Wno-error', '-fpermissive', '-std=gnu++11', '-march=native', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXFLAGS = ['-Wall', '-Wno-error', '-fpermissive', '-std=gnu++11', '-march=native']
CXXFLAGS_MACBUNDLE = ['-fPIC']
CXXFLAGS_PTHREAD = '-pthread'
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fwrapv', '-fno-strict-aliasing']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-fwrapv', '-fno-strict-aliasing', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['udp-client-server', 'udp', 'ipv6', 'energy', 'realtime', 'wireless', 'naming', 'tcp', 'tutorial', 'error-model', 'matrix-topology', 'socket', 'routing', 'stats']
EXEC_PREFIX = '/usr/local'
HTMLDIR = '/usr/local/share/doc/ns'
INCLUDEDIR = '/usr/local/include'
INCLUDES_LIBXML2 = ['/usr/include/libxml2']
INCLUDES_PYEMBED = ['/home/k0x/.pyenv/versions/2.7.18/include/python2.7']
INCLUDES_PYEXT = ['/home/k0x/.pyenv/versions/2.7.18/include/python2.7']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_PYEMBED = ['/home/k0x/.pyenv/versions/2.7.18/lib']
LIBPATH_PYEXT = ['/home/k0x/.pyenv/versions/2.7.18/lib']
LIBPATH_PYTHON2.7 = ['/home/k0x/.pyenv/versions/2.7.18/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_LIBXML2 = ['xml2']
...
LINKFLAGS_PYEMBED = ['-Wl,-rpath,/home/k0x/.pyenv/versions/2.7.18/lib']
LINKFLAGS_PYEXT = ['-Wl,-rpath,/home/k0x/.pyenv/versions/2.7.18/lib', '-Wl,-rpath,/home/k0x/.pyenv/versions/2.7.18/lib']
...
NS3_EXECUTABLE_PATH = ['/home/k0x/netsec/ns-3-stdma/sources/build/src/emu', '/home/k0x/netsec/ns-3-stdma/sources/build/src/fd-net-device', '/home/k0x/netsec/ns-3-stdma/sources/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/13', '/home/k0x/netsec/ns-3-stdma/sources/build']
...
PYFLAGS_OPT = '-O'
PYO = 1
PYTHON = ['/home/k0x/.pyenv/versions/2.7.18/bin/python']
PYTHONARCHDIR = '/usr/local/lib/python2.7/site-packages'
PYTHONDIR = '/usr/local/lib/python2.7/site-packages'
PYTHON_CONFIG = '/home/k0x/.pyenv/versions/2.7.18/bin/python-config'
PYTHON_VERSION = '2.7'
...
cfg_files = ['/home/k0x/netsec/ns-3-stdma/sources/build/ns3/config-store-config.h', '/home/k0x/netsec/ns-3-stdma/sources/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
